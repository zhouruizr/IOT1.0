...
namespace DataProvider.Paging
{
    public class PagerOptions
    {
        public PagerOptions()
        {
            ...
            //modified by zhongdian 2016/02/22
            this.AlwaysShowFirstLastPageNumber = true;
            this.CssClass = "dataTables_paginate paging_simple_numbers pagination";
            this.PageIndexParameterName = "pageindex";
            this.NumericPagerItemCount = 6;
            this.CurrentPagerItemWrapperFormatString = "<li class= 'paginate_button'><a class='active' href='javascript:;'>{0}</a></li>";
            this.MorePagerItemWrapperFormatString = "<span class='ifn'>{0}</span>";
        }
